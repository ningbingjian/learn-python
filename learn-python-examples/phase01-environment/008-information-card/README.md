...
[阶段导航](../README.md) · [上一课：01-007](../007-virtual-environment/README.md) · 下一步：阶段 02 详细大纲（待编写）
...
下一阶段要解决“字段都写死，改动与计算不方便”的问题，再引入变量、类型与表达式。先完成阶段 02 详细大纲，再按课生成内容；不用现在就在信息卡里提前加入没学过的高级写法。
